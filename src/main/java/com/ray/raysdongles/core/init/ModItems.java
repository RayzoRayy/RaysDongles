    ...
    public static void register(IEventBus eventBus) {
        ...
        if (ConfigGeneral.disableAmethystArmor.get()) {
            RegistryObject<Item> AMETHYST_HELMET = ITEMS.register("amethyst_helmet",
                    () -> new ArmorItem(RaysArmorMaterials.AMETHYST, ArmorItem.Type.HELMET, props()));
            RegistryObject<Item> AMETHYST_CHEST = ITEMS.register("amethyst_chestplate",
                    () -> new ArmorItem(RaysArmorMaterials.AMETHYST, ArmorItem.Type.CHESTPLATE, props()));
            RegistryObject<Item> AMETHYST_LEGS = ITEMS.register("amethyst_leggings",
                    () -> new ArmorItem(RaysArmorMaterials.AMETHYST, ArmorItem.Type.LEGGINGS, props()));
            RegistryObject<Item> AMETHYST_BOOTS = ITEMS.register("amethyst_boots",
                    () -> new ArmorItem(RaysArmorMaterials.AMETHYST, ArmorItem.Type.BOOTS, props()));
        }
            if (ConfigGeneral.disableRubyArmor.get()) {
                RegistryObject<Item> RUBY_HELMET = ITEMS.register("ruby_helmet",
                        () -> new ArmorItem(RaysArmorMaterials.RUBY, ArmorItem.Type.HELMET, props()));
                RegistryObject<Item> RUBY_CHEST = ITEMS.register("ruby_chestplate",
                        () -> new ArmorItem(RaysArmorMaterials.RUBY, ArmorItem.Type.CHESTPLATE, props()));
                RegistryObject<Item> RUBY_LEGS = ITEMS.register("ruby_leggings",
                        () -> new ArmorItem(RaysArmorMaterials.RUBY, ArmorItem.Type.LEGGINGS, props()));
                RegistryObject<Item> RUBY_BOOTS = ITEMS.register("ruby_boots",
                        () -> new ArmorItem(RaysArmorMaterials.RUBY, ArmorItem.Type.BOOTS, props()));
            }
        if (ConfigGeneral.disableTopazArmor.get()) {
            RegistryObject<Item> TOPAZ_HELMET = ITEMS.register("topaz_helmet",
                    () -> new ArmorItem(RaysArmorMaterials.TOPAZ, ArmorItem.Type.HELMET, props()));
            RegistryObject<Item> TOPAZ_CHEST = ITEMS.register("topaz_chestplate",
                    () -> new ArmorItem(RaysArmorMaterials.TOPAZ, ArmorItem.Type.CHESTPLATE, props()));
            RegistryObject<Item> TOPAZ_LEGS = ITEMS.register("topaz_leggings",
                    () -> new ArmorItem(RaysArmorMaterials.TOPAZ, ArmorItem.Type.LEGGINGS, props()));
            RegistryObject<Item> TOPAZ_BOOTS = ITEMS.register("topaz_boots",
                    () -> new ArmorItem(RaysArmorMaterials.TOPAZ, ArmorItem.Type.BOOTS, props()));
        }
            if (ConfigGeneral.disableWitheredArmor.get()) {
            WITHERED_HELMET = ITEMS.register("withered_helmet",
                    () -> new WitheredArmor(RaysArmorMaterials.WITHERED, ArmorItem.Type.HELMET, props()));
            WITHERED_CHEST = ITEMS.register("withered_chestplate",
                    () -> new WitheredArmor(RaysArmorMaterials.WITHERED, ArmorItem.Type.CHESTPLATE, props()));
             WITHERED_LEGS = ITEMS.register("withered_leggings",
                    () -> new WitheredArmor(RaysArmorMaterials.WITHERED, ArmorItem.Type.LEGGINGS, props()));
             WITHERED_BOOTS = ITEMS.register("withered_boots",
                    () -> new WitheredArmor(RaysArmorMaterials.WITHERED, ArmorItem.Type.BOOTS, props()));
        }
        //Charms
