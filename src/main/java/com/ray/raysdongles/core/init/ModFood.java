...
import com.ray.raysdongles.common.items.foods.*;
import com.ray.raysdongles.core.config.ConfigGeneral;
import com.ray.raysdongles.common.items.foods.DrinkItem;
...
public static RegistryObject<Item> TOMATO_JUICE = null;
    public static final DeferredRegister<Item> FOODS = DeferredRegister.create(ForgeRegistries.ITEMS, RaysDongles.MOD_ID);
