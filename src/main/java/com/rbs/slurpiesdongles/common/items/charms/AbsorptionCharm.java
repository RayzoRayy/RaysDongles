...
public class AbsorptionCharm extends CharmItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        tooltip.add(new TextComponent("Having this item in your inventory grants you 2 Absorbtion hearts every 10 seconds. Please allow 10 seconds to apply your hearts when you first craft the item"));
    }
