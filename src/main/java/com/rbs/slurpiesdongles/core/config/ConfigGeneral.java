...
public class ConfigGeneral {
    ...
    public static void init(ForgeConfigSpec.Builder builder) {
        ...
        wildCropsChance = builder
                .comment("Chance of wild crops generating in the Overworld. Higher numbers mean a higher change to spawn per chunk chance [default: 32]")
                .comment("0 should disable Wild Crops spawning")
                .defineInRange("Chance of Wild Crops spawning", 32, 0, 1000000000);
        wildCropsChunkGeneration = builder
                .comment("Average spawn every X chunks, X being the number per chunk")
                .comment("Default is every 6 chunks")
                .defineInRange("Sets the number of Wild Crops per chunk", 6, 1, 16);
        wildCropsXZSpread = builder
                .comment("X & Z Spread of the Wild Crops [default: 6]")
                .defineInRange("Sets the X & Z spread of Wild Crops", 6, 0, 64);
        wildCropsYSpread = builder
                .comment("Y Spread of the Wild Crops [default: 3]")
                .defineInRange("Sets the Y spread of Wild Crops", 3, 0, 64);
        builder.pop();
        //Drinks
