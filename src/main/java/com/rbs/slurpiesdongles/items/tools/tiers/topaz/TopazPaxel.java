...
public class TopazPaxel extends ToolItem {
    ...
    public TopazPaxel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Set<Block> EFFECTIVE_ON, Properties builder, String name) {
