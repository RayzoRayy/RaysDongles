...
public class IronHammer extends PickaxeItem implements SDTool {
    public IronHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
