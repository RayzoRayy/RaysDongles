...
public class VMExcavator extends ShovelItem implements SDTool {
    public VMExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
