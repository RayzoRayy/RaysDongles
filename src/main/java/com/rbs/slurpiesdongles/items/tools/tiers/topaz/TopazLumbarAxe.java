...
public class TopazLumbarAxe extends AxeItem {
    ...
    public TopazLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
