...
public class WoodenLumbarAxe extends AxeItem {
    ...
    public WoodenLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
