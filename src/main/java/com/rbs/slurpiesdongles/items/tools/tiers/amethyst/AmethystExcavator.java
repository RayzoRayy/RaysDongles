...
public class AmethystExcavator extends ShovelItem implements SDTool {
    public AmethystExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
