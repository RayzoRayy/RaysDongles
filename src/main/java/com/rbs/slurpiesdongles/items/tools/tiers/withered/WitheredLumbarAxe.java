...
public class WitheredLumbarAxe extends AxeItem {
    ...
    public WitheredLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
    ...
    public boolean onBlockDestroyed(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity entityLiving) {
        stack.attemptDamageItem(0, ToolHelper.random, null);//Set to 6 because generally a tree is 6 tall ish
