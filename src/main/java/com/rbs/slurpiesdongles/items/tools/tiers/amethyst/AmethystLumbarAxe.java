...
public class AmethystLumbarAxe extends AxeItem {
    ...
    public AmethystLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
