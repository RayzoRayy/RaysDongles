...
public class StoneExcavator extends ShovelItem implements SDTool {
    public StoneExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
