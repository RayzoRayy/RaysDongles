...
public class WitheredExcavator extends ShovelItem implements SDTool {
    public WitheredExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
