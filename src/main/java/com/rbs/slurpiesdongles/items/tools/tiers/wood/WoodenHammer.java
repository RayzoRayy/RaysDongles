...
public class WoodenHammer extends PickaxeItem implements SDTool {
    public WoodenHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
