...
public class DiamondLumbarAxe extends AxeItem {
    ...
    public DiamondLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
