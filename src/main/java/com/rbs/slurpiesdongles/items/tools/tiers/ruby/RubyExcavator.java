...
public class RubyExcavator extends ShovelItem implements SDTool {
    public RubyExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
