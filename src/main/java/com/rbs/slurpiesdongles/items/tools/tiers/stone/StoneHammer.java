...
public class StoneHammer extends PickaxeItem implements SDTool {
    public StoneHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
