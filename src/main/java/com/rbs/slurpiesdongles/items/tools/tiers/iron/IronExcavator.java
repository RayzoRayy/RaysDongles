...
public class IronExcavator extends ShovelItem implements SDTool {
    public IronExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
