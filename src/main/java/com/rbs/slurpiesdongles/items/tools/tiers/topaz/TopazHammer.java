...
public class TopazHammer extends PickaxeItem implements SDTool {
    public TopazHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
