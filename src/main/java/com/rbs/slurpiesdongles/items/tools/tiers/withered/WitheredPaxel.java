...
public class WitheredPaxel extends ToolItem {
    ...
    public WitheredPaxel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder , String name) {
        ...
        if (block != null) {
            ...
            if (!world.isRemote) {
                ...
                if (playerentity != null) {
                    useContext.getItem().damageItem(0, playerentity, (p_220040_1_) -> {
            ...
            if (iblockstate1 != null) {
                ...
                if (!world.isRemote) {
                    ...
                    if (entityplayer != null) {
                        useContext.getItem().damageItem(0, entityplayer, (p_220040_1_) -> {
                            p_220040_1_.sendBreakAnimation(useContext.getHand());
                        });
                    }
                }
                ...
                if (iblockstate3 != null) {
                    ...
                    if (!world.isRemote) {
                        ...
                        if (entityplayer2 != null) {
                            useContext.getItem().damageItem(0, entityplayer2, (p_220040_1_) -> {
                                p_220040_1_.sendBreakAnimation(useContext.getHand());
                            });
                        }
                    }
