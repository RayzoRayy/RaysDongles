...
public class DiamondPaxel extends ToolItem {
    ...
    public DiamondPaxel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Set<Block> EFFECTIVE_ON, Properties builder, String name) {
