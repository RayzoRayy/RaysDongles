...
public class TopazExcavator extends ShovelItem implements SDTool {
    public TopazExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
