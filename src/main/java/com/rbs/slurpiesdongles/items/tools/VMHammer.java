...
public class VMHammer extends PickaxeItem implements SDTool {
    public VMHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
