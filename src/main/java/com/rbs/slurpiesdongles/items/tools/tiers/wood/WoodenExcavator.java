...
public class WoodenExcavator extends ShovelItem implements SDTool {
    public WoodenExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
