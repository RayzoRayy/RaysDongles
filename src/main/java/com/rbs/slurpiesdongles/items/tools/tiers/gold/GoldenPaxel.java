...
public class GoldenPaxel extends ToolItem {
    ...
    public GoldenPaxel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Set<Block> EFFECTIVE_ON, Properties builder, String name) {
