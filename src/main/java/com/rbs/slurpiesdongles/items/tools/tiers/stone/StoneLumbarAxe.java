...
public class StoneLumbarAxe extends AxeItem {
    ...
    public StoneLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
