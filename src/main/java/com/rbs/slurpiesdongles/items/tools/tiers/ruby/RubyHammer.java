...
public class RubyHammer extends PickaxeItem implements SDTool {
    public RubyHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
