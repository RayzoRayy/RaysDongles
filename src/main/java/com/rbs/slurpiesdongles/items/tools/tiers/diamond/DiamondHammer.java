...
public class DiamondHammer extends PickaxeItem implements SDTool {
    public DiamondHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
