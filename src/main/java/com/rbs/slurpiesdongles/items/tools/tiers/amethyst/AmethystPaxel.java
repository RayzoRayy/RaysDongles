...
public class AmethystPaxel extends ToolItem {
    ...
    public AmethystPaxel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Set<Block> EFFECTIVE_ON, Properties builder, String name) {
