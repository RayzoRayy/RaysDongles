...
public class GoldenHammer extends PickaxeItem implements SDTool {
    public GoldenHammer(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
