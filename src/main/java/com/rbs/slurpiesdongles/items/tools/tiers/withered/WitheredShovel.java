...
public class WitheredShovel extends ShovelItem {
    public WitheredShovel(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder , String name) {
