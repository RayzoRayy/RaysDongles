...
public class DiamondExcavator extends ShovelItem implements  SDTool{
    public DiamondExcavator(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder, String name) {
