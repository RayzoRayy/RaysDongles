...
public class GoldenLumbarAxe extends AxeItem {
    ...
    public GoldenLumbarAxe(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder, String name) {
