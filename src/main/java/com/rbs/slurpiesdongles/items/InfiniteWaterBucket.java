...
public class InfiniteWaterBucket extends Item {
    ...
    public InfiniteWaterBucket(Properties properties, String name, Fluid containedFluidIn) {
        super(properties);
    ...
    protected ItemStack emptyBucket(ItemStack p_203790_1_, PlayerEntity p_203790_2_) {
        return !p_203790_2_.abilities.isCreativeMode ? new ItemStack(this) : p_203790_1_;
    }
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.CompoundNBT nbt) {
        if (this.getClass() == InfiniteWaterBucket.class)
